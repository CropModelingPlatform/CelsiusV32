...
Dim IdSol As String * 3
Dim typsol As String
Dim NbCouches As Integer
Dim epc(1 To 5) As Integer 'VX, epaisseur de la couche de sol (cm) (sur 5 couches popssibles au maximum)
Dim hcc(1 To 5) As Double 'VX, humidité pondérale à la capacité au champ pour la couche (%)
Dim hmin(1 To 5) As Double 'VX, humidité pondérale au point de flétrissement permanent pour la couche (%)
Dim da(1 To 5) As Double 'VX, densité apparente (sd)
...
Dim StNJ(0 To 731) As Double 'Vx stock du sol en azote (kg/ha/an) -  version journalière
Dim StCJ(0 To 731) As Double 'Vx stock du sol en carbone (kg/ha/an) -  version journalière
...
Dim CminMOSJour(0 To 731) As Double, CminResJour(0 To 731) As Double ''VE C minéralisés par jour  à partir de la MOS (-MOSJour) et des amendements organiques (-ResJour)
...
Dim ConcNsol(0 To 731) As Double 'concentration en azote de l'eau du sol kg N/10 mètres cubes d'eau
...
Dim perteNDrain(0 To 731) As Double  'pertes d'azote par drainage kg/ha
...
Dim MinNorgInput(0 To 731) As Double  'VE, Minéralisation journalière de l'azote de la MO apporté(Kg/ha)
...
Sub LisSol(DataBase_Cnn As ADODB.Connection, SimUnit As SimulationUnitClass, Zgraine As Integer, DriveRui As Boolean)
...
End Sub
Sub SeasonMinNC(Nfresh As Double, CsNfresh As Double, KresY As Double, SMT As Double, Napportmin As Double)
...
End Sub
Sub InitSolRecurs(EtatFinal As EtatFinalClass)
...
End Sub
Sub evaporation(Joursim As Integer, EoSM As Double, Eomulch As Double, pousse As Boolean)
...
End If
End Sub
Sub MinMOSStics(Joursim As Integer)
...
End Sub
Sub MinNorgapporteStics(Joursim As Integer, Qorga As Double, CsurNRes As Double, ApportOrga As ApportsOrgaClass)
...
End If
End Sub
Sub ConcNEauSol(Joursim, ZracmaxMC As Double)
...
End Sub
Sub EauSol(Joursim As Integer, precip As Double, transpi As Double, Zrac As Double, Deltazrac As Double, Zracmax As Integer, pousse As Boolean)
...
End If
End Sub
Sub BilanNFin(Nplante As Double, Napportmin As Double, nbjsimul As Integer, Zracmax As Double)
Dim J As Integer
...
End Sub
Property Get dEsol(Joursim As Integer)
dEsol = Esol(Joursim)
End Property
Property Get dZoneHumSousRacines() As Double
dZoneHumSousRacines = ZoneHumSousRacines
End Property
Property Get dContrainteW() As Double
dContrainteW = ContrainteW
End Property
Property Get dContrainteWSurf() As Double
dContrainteWSurf = ContrainteWSurf
End Property
Property Get dStsurf(Joursim As Integer) As Double
dStsurf = Stsurf(Joursim)
End Property
Property Get dStrac(Joursim As Integer) As Double
dStrac = Strac(Joursim)
End Property
Property Get dStnonrac(Joursim As Integer) As Double
dStnonrac = Stnonrac(Joursim)
End Property
Property Get dDrprofmax(Joursim As Integer) As Double
dDrprofmax = Drprofmax(Joursim)
End Property
Property Get dStockSol(Joursim As Integer) As Double
dStockSol = Stocksol(Joursim)
End Property
Property Get dStprofond(Joursim As Integer) As Double
dStprofond = Stprofond(Joursim)
End Property
Property Get iZtotsol() As Integer
iZtotsol = Ztotsol
End Property
Property Get dStockMes(Joursim As Integer) As Double
dStockMes = StockMes(Joursim)
End Property
Property Get dSigmaSimEsol() As Double
dSigmaSimEsol = SigmaSimEsol
End Property
Property Get dSigmaCultEsol() As Double
dSigmaCultEsol = SigmaCultEsol
End Property
Property Get dSigmaSimDrprofmax() As Double
dSigmaSimDrprofmax = SigmaSimDrprofmax
End Property
Property Get dSigmaSimDr() As Double
dSigmaSimDr = SigmaSimDr
End Property
Property Get nZObstacleRac() As Integer
nZObstacleRac = ZObstacleRac
End Property
Property Get bContrainteHlevee() As Boolean
bContrainteHlevee = ContrainteHlevee
End Property
Property Get dStger(Joursim As Integer) As Double
dStger = Stger(Joursim)
End Property
Property Get dStockN() As Double
dStockN = StockN
End Property
Property Get dStockP() As Double
dStockP = StockP
End Property
Property Get dStockK() As Double
dStockK = StockK
End Property
Property Get nSignalFletrissement(Joursim As Integer) As Integer
nSignalFletrissement = SignalFletrissement(Joursim)
End Property
Property Get ClTypeSurf() As Object
Set ClTypeSurf = TypeSurf
End Property
Property Get dConcNsol(Joursim As Integer) As Double
dConcNsol = ConcNsol(Joursim)
End Property
Property Get dVolEausol() As Double
dVolEausol = VolEausol
End Property
Property Get bDrainageON(Joursim As Integer) As Boolean
bDrainageON = DrainageON(Joursim)
End Property
Property Get dperteNDrain(Joursim As Integer) As Double
dperteNDrain = perteNDrain(Joursim)
End Property
Property Get dDr(Joursim As Integer) As Double
dDr = Dr(Joursim)
End Property
Property Get dNavail(Joursim As Integer) As Double
dNavail = Navail(Joursim)
End Property
Property Get dCNmin(Joursim As Integer) As Double
dCNmin = CNmin(Joursim)
End Property
Property Get dNmin(Joursim As Integer) As Double
dNmin = Nmin(Joursim)
End Property
Property Get dNDenit(Joursim As Integer) As Double
dNDenit = NDenit(Joursim)
End Property
Property Get dCNDenit(Joursim As Integer) As Double
dCNDenit = CNDenit(Joursim)
End Property
Property Get dMinNorgInput(Joursim As Integer) As Double
dMinNorgInput = MinNorgInput(Joursim)
End Property
Property Get dNmintot() As Double
dNmintot = Nmintot
End Property
Property Get dtxminN() As Double
dtxminN = txminN
End Property
Property Get dFminY1() As Double
dFminY1 = FminY1
End Property
Property Get dStockN1() As Double
dStockN1 = StockN1
End Property
Property Get dStockC1() As Double
dStockC1 = StockC1
End Property
Property Get dCmintot() As Double
dCmintot = Cmintot
End Property
Property Get dCminRes() As Double
dCminRes = CminRes
End Property
Property Get dNminMOSY() As Double
dNminMOSY = NminMOSY
End Property
Property Get dNminRes() As Double
dNminRes = NminRes
End Property
Property Get dCumPerteNdrain() As Double
dCumPerteNdrain = CumPerteNdrain
End Property
Property Get dNreliquat() As Double
dNreliquat = Nreliquat
End Property
Property Get dStockC() As Double
dStockC = StockC
End Property
Property Get dSigmaCultDrprofmax() As Double
dSigmaCultDrprofmax = SigmaCultDrprofmax
End Property
Property Get dCumPerteNdrainCult() As Double
dCumPerteNdrainCult = CumPerteNdrainCult
End Property
Property Get bBilanNnonOK() As Boolean
bBilanNnonOK = BilanNnonOK
End Property
Property Get dStNJ(Joursim As Integer) As Double
dStNJ = StNJ(Joursim)
End Property
Property Get dStCJ(Joursim As Integer) As Double
dStCJ = StCJ(Joursim)
End Property
Property Get dCminMOSJour(Joursim As Integer) As Double
dCminMOSJour = CminMOSJour(Joursim)
End Property
Property Get dCminResJour(Joursim As Integer) As Double
dCminResJour = CminResJour(Joursim)
End Property
Property Get dPRedFact() As Double
dPRedFact = PRedFact
End Property