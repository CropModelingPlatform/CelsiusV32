...
Public Class SimulationControlClass
    ...
    Public Sub ReadParameters(rstSimulation As ADODB.Recordset, DataBase_Cnn As ADODB.Connection, comptesim As Long)
    ...
    If GestionTechnique.bfertiorgON Then
        ...
        If dataFertiOrg.sTypeMorga <> "indetermine" Then
          ApportOrga = New ApportsOrgaClass
    ...
    End If
    End Sub
    Public Sub SortieSynthesis(TabSynt As ADODB.Recordset)
    ...
    End Sub
    Public Sub EcritDresu(Db_Cnn As ADODB.Connection, comptesim As Long)

    Dim jour As Integer
    Dim icult As Integer
    Dim TabDayPlante(2) As ADODB.Recordset
    'TODO: integrer modifs proposées par Guillaume sur conseils IA (begintrans, CommitTrans et vidage table antérieure par SQL)

        For icult = 1 To GestionTechnique.nNbCult
            TabDayPlante(icult) = New ADODB.Recordset
    ...
    End While
        ...
        End If 'fin cas où ecritdresus est vrai
            ...
            TabDayPlante(icult) = Nothing
        Next icult
    End Sub
    Public Sub MemoEtatFinal()
    EtatFinal = New EtatFinalClass
    Call EtatFinal.EcritEF2(Sol, plante, mulch, SimUnit.nNbJourSimul)
    End Sub
    Public Function Coptionsmodel() As OptionsModelClass
    Return OptionsModel
    End Function
    Public Function sIdentSimul() As String
    Return IdentSimul
    End Function
End Class
