...
Public Class CultureClass
    ...
    Public Sub InitMixedCanopy(extin As Double, Zracmax As Integer, Kmax As Double, Pfactor As Double)
    ...
    End Sub
    Public Sub LaiMixedCanopy(Joursim As Integer, Lai As Double)
    ...
    End Sub
    Public Sub CroiRacMixedCrop(Joursim As Integer, Zrac As Double)
    'on prend la cote maximale atteinte par les plantes de l'assoc
    ZRacineMC(Joursim) = Max(Zrac, ZRacineMC(Joursim))
    End Sub
    Public Sub Evaporation_Pot_SolMulch(Joursim, Etp)
    ' EoSM = évaporation potentielle au sommet du mulch (sous la canopée)
    EoSM = Etp * Exp(-delta * (LaiMC(Joursim)))
    End Sub
    Public Sub CalcTranspiMC(Joursim As Integer, Etp As Double, Esol As Double, Emulch As Double, ContrainteW As Double)
    ...
    End Sub
    Public Sub NuptakeMixedCrop(Joursim, Nuptake)

    NuptMC(Joursim) = NuptMC(Joursim) + Nuptake

    End Sub
    Public Function dLaiMC(Joursim As Integer) As Double
    Return LaiMC(Joursim)
    End Function
    Public Function dEoSM() As Double
    Return EoSM
    End Function
    Public Function dZRacineMC(Joursim As Integer) As Double
    Return ZRacineMC(Joursim)
    End Function
    Public Function dZracmaxMC() As Integer
    Return ZracmaxMC
    End Function
    Public Function dTranspiMC(Joursim As Integer) As Double
    Return TranspiMC(Joursim)
    End Function
    Public Function dSigmaTranspiMC() As Double
    Return SigmaTranspiMC
    End Function
    Public Function dTPotMC(Joursim As Integer) As Double
    Return TPotMC(Joursim)
    End Function
    Public Function dNuptMC(Joursim As Integer) As Double
