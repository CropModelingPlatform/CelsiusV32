...
Public Module Functions
    ...
    Public Function Julian(dat1) As Object
    If IsNull(dat1) Then
    Julian = Nothing
    Else
    ...
    End Function
    Public Function ET0pm(lat, Alt, J, Tn, Tx, Tm, Un, Ux, Vm, Rg) As Object
    ...
    End If
    End Function
    Public Function ET0pen48(lat, Alt, J, Tn, Tx, Tm, Un, Ux, Vm, Rg) As Object
    ...
    ET0pen48 = Rad + adv
    End Function
    Public Function ET0pm_Tdew(lat, Alt, J, Tn, Tx, Tm, Tdewn, Tdewx, Vm, Rg) As Object
    'Calculates ET0 according to FAO Penman-Monteith Equation (Bull.FAO#56)
    'altitude Alt in m, latitude in decimal degrees
    'J in number of the day in the year
    'Tn, Tx and Tm respectively minimal,maximal and mean daily temperature in degrees C,
