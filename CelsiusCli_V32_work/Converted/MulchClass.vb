...
Public Class MulchClass
    Dim Qpaillis(731) As Double 'VE quantité de paillis présente au sol chaque jour (Mg/ha)
    Dim Eomulch As Double 'VE, évaporation potentielle du mulch (mm)
    Dim Emulch(731) As Double 'VE, évaporation du mulch (mm)
    ...
    Dim Ruis(731) As Double 'VE, ruissellement journalier (mm)
    ...
    Public Sub LisMulch(DataBase_Cnn As ADODB.Connection, CodParamMulch As Integer, Qpaillisinit As Double)
    Dim Trouve As Boolean
    Dim msg As String
    rstMulchData = New ADODB.Recordset
    ...
    End If
    End Sub
    Public Sub LisRuiObs(DataBase_Cnn As ADODB.Connection, SimUnit As SimulationUnitClass)
    ...
    rstDataRuiObs = New ADODB.Recordset
    ...
    End Sub
    Public Sub BiomasseMulch(Joursim As Integer, jourpaillage As Boolean, QpaillisApport As Double)
    ...
    End Sub
    Public Sub BilanMulch(Joursim As Integer, EoSM As Double, precip As Double)
    ...
    End Sub
    Public Sub Ruissellement(Joursim As Integer, precip As Double, TypeSurf As TypeSurfClass, Lai As Double)
    ...
    End Sub
    Public Function dEomulch() As Double
    Return Eomulch
    End Function
    Public Function dEmulch(Joursim As Integer) As Double
    Return Emulch(Joursim)
    End Function
    Public Function dEauVersSol() As Double
    Return EauVersSol
    End Function
    Public Function dEau_vers_Mulch() As Double
    Return Eau_vers_Mulch
    End Function
    Public Function dSigmaSimEmulch() As Double
    Return SigmaSimEmulch
    End Function
    Public Function dSigmaSimRuis() As Double
    Return SigmaSimRuis
    End Function
    Public Function dRuis(Joursim As Integer) As Double
    Return Ruis(Joursim)
    End Function
    Public Function dQpaillis(Joursim As Integer) As Double
    Return Qpaillis(Joursim)
    End Function
    Public Function dSigmaSimPluM() As Double
    Return SigmaSimPluM
    End Function
    Public Function bRuisEtrange() As Boolean
    Return RuisEtrange
    End Function
End Class
